    ...
    (function() {
      ...
      function Uc(a) {
        return Ob(a, Z, 1).map(function(b) {
          var c = S(b, 1);
          return { index: null == c ? 0 : c, qa: W(b, 2), label: null != S(b, 3) ? Rb(S(b, 3), "") : void 0, displayName: null != S(b, 4) ? Rb(S(b, 4), "") : void 0 };
        });
      }
      ;
      function Vc(a) {
              ...
              if ("detection_list" === r.type) {
                if (p) {
                  ...
                  for (var J = p.getLandmarksList(), I = p.getClassificationsList(), u = [], C = 0; C < B.size(); ++C) {
                    var T = Sc(B.get(C)), od = W(T, 1), pd = W(T, 2), qd = W(T, 3), rd = W(T, 4), sd = W(T, 5, 0), za = void 0;
                    za = void 0 === za ? 0 : za;
                    T = { la: { sa: od, ta: pd, height: qd, width: rd, rotation: sd, pa: Rb(S(T, 6), za) }, ea: Ob(Pc(J.get(C)), Lc, 1).map(Vc), ba: Uc(Kc(I.get(C))) };
                    u.push(T);
                  }
                  B = u;
                } else B = [];
...
export default require_selfie_segmentation();
//# sourceMappingURL=@mediapipe_selfie_segmentation.js.map
